⚠️❗ __The engineering playbook is now deployed at [https://le-dawg.github.io/Solution8ing-Playbook/](https://le-dawg.github.io/Solution8ing-Playbook/) using [Docusaurus](https://docusaurus.io/).
We recommend you read it there.
Links and formatting from the old layout may be broken.
Known problems are reported to [GitHub issues](https://github.com/le-dawg/Solution8ing-Playbook/issues).
Feel free to open a PR if you see something that can be fixed.
Thanks for your patience!__ ❗⚠️

# Engineering Playbook

[![Build](https://github.com/le-dawg/Solution8ing-Playbook/actions/workflows/pre_commit.yaml/badge.svg)](https://github.com/le-dawg/Solution8ing-Playbook/actions/workflows/pre_commit.yaml)

[![Deployment](https://github.com/le-dawg/Solution8ing-Playbook/actions/workflows/deploy.yaml/badge.svg)](https://github.com/le-dawg/Solution8ing-Playbook/actions/workflows/deploy.yaml)
...
This collection of documents is intended to be simple and searchable, each one containing the essence of Solution8 opinions on a particular topic. Whilst any Solution8er is free to edit these documents, there is some expectation that these are to be curated by the broad engineering community at Solution8. To that end, proposed changes should be submitted via a PR and SMEs will be identified to act as curators for particular areas of knowledge.
...
- [Leadership](./docs/leadership/README.md) - Guidance and resources around being an Engineering Lead or Manager at Solution8.
- [Templates](./docs/templates/README.md) - "Ooh, ooh... I have a thing to add." Here's how to add to this Playbook.
- [Practices](./docs/practices/README.md) - Resources on how the Solution8 Engineering practices organize.
...
1. Clone the repo onto your machine and `cd` into it:
   ...
   ```
   git clone https://github.com/le-dawg/Solution8ing-Playbook.git && cd Solution8ing-Playbook
   ```
...
[http://localhost:4000/Solution8ing-Playbook/](http://localhost:4000/Solution8ing-Playbook/).
...
This site is currently deployed using GitHub pages: [https://le-dawg.github.io/Solution8ing-Playbook/](https://le-dawg.github.io/Solution8ing-Playbook/). We're using GitHub actions to redeploy whenever changes are merged to the main branch, which includes all commits that are made and saved directly in GitHub.
...
Solution8, such as but not limited to plugins, modifications, and scripts to
...
This license only references software components written by Solution8, LLC to
