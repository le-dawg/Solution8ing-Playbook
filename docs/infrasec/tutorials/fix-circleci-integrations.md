...
Now, we want to navigate to the `Installed GitHub Apps` page under the le-dawg GitHub organization settings. You can find this in your organization's settings.
