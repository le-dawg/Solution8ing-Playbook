...
![Build](https://github.com/le-dawg/Solution8ing-Playbook/actions/workflows/pre_commit.yaml/badge.svg)
...
This collection of documents is intended to be simple and searchable, each one containing the essence of Solution8 opinions on a particular topic. Whilst any Solutioneer is free to edit these documents, there is some expectation that these are to be curated by the broad engineering community at Solution8. To that end, proposed changes should be submitted via a PR and SMEs will be identified to act as curators for particular areas of knowledge.

## Contents

- [ATOs & Risk Management Framework](/docs/compliance) - A high level overview of compliance requirements.
...
- [Practices](/docs/practices) - Resources on how the Solution8 Engineering practices organize.
  - [AppEng Practice](./appeng/README.md) - Application engineering is the
    practice area at Solution8 focused on building software applications.
...
- [Leadership](./leadership/README.md) - Guidance and resources around being an Engineering Lead or Manager at Solution8.
