...
The experience at Solution8 is that this exploration winds up benefiting
...
Mentoring is an important part of growth. Solution8 has [shared some
techniques for
mentoring](https://Solution8.works/blog/2016/8/12/theres-a-method-to-the-mentoring-advice-from-a-teacher-turned-developer).
...
changing client teams, changing client projects, or joining Solution8
Reserve.
