...
Solution8 has a clear set of values and expectations when it comes to meetings (see
our [blog post](https://Solution8.works/blog/2017/2/3/well-met-the-software-engineering-meetings-you-actually-need)).
...
the technical and professional, another advantage of our pairing set up at Solution8
is that pairing can act as a buffer between client and more junior team members.
We expect each individual Solution8el to work side by side with the client, but
